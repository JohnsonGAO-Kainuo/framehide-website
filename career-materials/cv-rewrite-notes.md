...
- **数字产品篇幅**：保留四款产品、App Store、推广测试、初期用户和付费订阅，但压缩为一个要点，不把自己描述成软件工程师。
- **创业结果**：可以说完成了早期验证和可衡量成果，不能说已经形成规模化业务，也不必主动称为“创业失败”。
- **签证**：主简历默认不写；被问时说明持有效 IANG、无需雇主担保，并预计自 2026 年 9 月起具备申请永居资格，最终以审批为准。
- **技能**：写可重复使用的能力，不单独罗列 ChatGPT、Claude、Codex 等通用工具。
- **证据原则**：所有数字、客户交付、样品结果和证书名称都应能够被邮件、网站、分析后台、合同或证书支持。
